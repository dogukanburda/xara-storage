...
var settings
var appName
var flowsFullPath = "/data/flows.json"
var flowsFileBackup = "/data/flows.bak"
module.exports = {
    init: (nrSettings) => {
    ...
    getFlows: async () => {
        return util.readFile(flowsFullPath, null, 'flow').then(function (result) {
            if (result === null) {
                return [];
            }
            return result;
    ...
    saveFlows: async (flow) => {
        // TODO: do something with backup flow file
        util.writeFile(flowsFullPath, flow, flowsFileBackup).then(() => {
